...
describe('SaveEventExpenseV2UseCase', () => {
  ...
  const testCases: SaveEventExpenseV2TestCase[] = [
    ...
    {
      name: 'должен сохранить связь с отменяемым расходом из того же события',
      initRelationalState: {
        events: [
          {
            id: 'event-1',
    ...
    {
      name: 'должен вернуть ошибку когда расход одновременно отменяет и заменяет другой расход',
      initRelationalState: {
        events: [
          {
            id: 'event-1',
    ...
    {
      name: 'должен вернуть ошибку когда отменяемый расход не найден в событии',
      initRelationalState: {
        events: [
          {
            id: 'event-1',
    ...
    {
      name: 'должен вернуть ошибку когда расход уже отменен другим расходом',
      initRelationalState: {
        events: [
          {
            id: 'event-1',
    ...
    {
      name: 'должен вернуть ошибку когда расход уже заменен другим расходом',
      initRelationalState: {
        events: [
          {
            id: 'event-1',
