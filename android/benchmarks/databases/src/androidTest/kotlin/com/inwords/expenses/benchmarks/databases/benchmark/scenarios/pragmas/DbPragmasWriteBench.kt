...
internal class DbPragmasWriteBench {

    @get:Rule
    val benchmarkRule = BenchmarkRule()

    @Test
    fun measureBaselineWriteNoExtraPragmas() {
        DbBenchmarkCaseRunner.runAbsolute(
            benchmarkRule = benchmarkRule,
            context = targetContext,
            benchmarkCase = DbAbsoluteMetricCase(
                tag = TAG,
                aspect = "pragmas_write_isolated",
                metric = "baseline",
                label = "no_extra_pragmas",
                dbName = "db_pragmas_write_baseline.db",
    ...
    @Test
    fun measureVariantWriteWithExtraPragmas() {
        DbBenchmarkCaseRunner.runAbsolute(
            benchmarkRule = benchmarkRule,
            context = targetContext,
            benchmarkCase = DbAbsoluteMetricCase(
                ...
                dbName = "db_pragmas_write_variant.db",
    ...
    private companion object {
        private const val TAG = "DbPragmasWriteBench"
    }
