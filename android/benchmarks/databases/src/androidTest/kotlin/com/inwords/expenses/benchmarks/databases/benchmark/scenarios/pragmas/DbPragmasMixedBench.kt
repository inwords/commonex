...
internal class DbPragmasMixedBench {

    @get:Rule
    val benchmarkRule = BenchmarkRule()

    @Test
    fun measureBaselineMixedNoExtraPragmas() {
        DbBenchmarkCaseRunner.runAbsolute(
            benchmarkRule = benchmarkRule,
            context = targetContext,
            benchmarkCase = DbAbsoluteMetricCase(
                tag = TAG,
                aspect = "pragmas_mixed_read_write",
                metric = "baseline",
                label = "no_extra_pragmas",
                dbName = "db_pragmas_mixed_baseline.db",
    ...
    @Test
    fun measureVariantMixedWithExtraPragmas() {
        DbBenchmarkCaseRunner.runAbsolute(
            benchmarkRule = benchmarkRule,
            context = targetContext,
            benchmarkCase = DbAbsoluteMetricCase(
                ...
                dbName = "db_pragmas_mixed_variant.db",
    ...
    private companion object {
        private const val TAG = "DbPragmasMixedBench"
    }
